    ...
    for row in sCursor:
        ...
        # If multiple countries are listed on a project record, parse the list apart and cross-reference against DSPN country list
            ...
            for indvCountry in countryNames:
                ...
                insertFields = str(nextID) + ", '" + sfID + "', '" + projName + "', '"  + indvCountry  + "', '" + fyString + "', '" + str(row[3]) + "', '" + str(row[4]) + "', '"  + projDonor1 + "', '" + projDonor2 + "', '" + projDonor3 + "', '" + projDonor4 + "', '" + projDonor5 + "', '" + region + "', '" + str(row[12]) + "', '" + str(row[13]) + "'"

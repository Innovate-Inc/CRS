            ...
            if len(response['locations']) == 0:
                ...
                if score <= 79.99:
                    ...
                    try:
                        ...
                        cbiString = "Select ID from Relationships where From_Institution__c = '" + str(row[1]) + "' and r.Second_Relationship_type__c like '%cbi%'"
                        #print cbiString
                        ...
                        insertFields = str(nextID) + ", '" + cleanAddress + "', '" + str(row[1]) + "', '"  + cleanName  + "', '" + str(score) + "', '" + str(row[3]) + "', '" + str(row[4]) + "', '" + str(row[5]) + "', '" + str(row[6]) + "', '" + str(row[7]) + "', '" + str(row[8]) + "', '" + str(cathPop) + "', '" + str(hispPop) + "', '" + str(numHS) + "', '" + str(numK8) + "', '" + str(numParish) + "', '" + str(totPop) + "', " + location + ", '" + diocese + "', '" + region + "', '" + congDist + "', '" + cbi + "', '" + pac + "', '" + usState + "', '" + row[16] + "', '" + str(sixMo) + "', '" + str(twelveMo) + "'"
